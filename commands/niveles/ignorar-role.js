...
module.exports = {
  name: "ignorar-role",
  description:
    "Ignorar que usuarios que tengan un role no puedan ganar experiencia",
  cooldown: 5,
  aliases: ["igr", "ignora-role", "ignorar-rol", "ignora-rol"],
  args: true,
  usage: "<role>",
  execute: async (client, message, args, prefix) => {
    ...
    const menciona_rol = new Discord.MessageEmbed()
      ...
      .setDescription(
        "<:risan:817538141585276989> Menciona un role al que no se dara experiencia, tambien puedes añadir mas"
      )
      .setColor("RED")
      .setTimestamp();
    ...
    if (busca_rol) {
      const rol_ya_añadido = new Discord.MessageEmbed()
        ...
        .setDescription(
          "<:risan:817538141585276989> El role que estas agregando ya estaba ingresado"
        )
        .setColor("RED")
        .setTimestamp();
      ...
      const añadido = new Discord.MessageEmbed()
        ...
        .setDescription("😎 Se ha agregado el role " + args[0])
        .setColor("GREEN")
        .setTimestamp();
